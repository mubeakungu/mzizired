# MziziBet - Casino Games Platform

> Looking for the previous version? View it on the [`backup-before-arcade` branch](https://github.com/YOUR_USERNAME/YOUR_REPO/tree/backup-before-arcade) *(update this link once you push under your own repo name)*.

<p align="center">
  <img src="./docs/images/banner.png" alt="MziziBet preview banner" />
</p>

<p align="center">
  <strong>A casino-style game platform — Crash, Plinko, Mines, and Dino — built with React, Vite, and modern frontend tooling.</strong>
</p>

<p align="center">
  <a href="https://YOUR-DEPLOYMENT-URL">Live Demo</a> <!-- update once deployed -->
  ·
...
<p align="center">
  <img src="./docs/images/lobby.png" alt="MziziBet game lobby preview" />
</p>
...
- is **not affiliated with Stake.com or any licensed gambling operator** — "MziziBet" is a placeholder demo name, not a registered betting brand
