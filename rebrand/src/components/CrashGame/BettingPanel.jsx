...
function BettingPanel({ phase, betPlaced, multiplier, onBet, onCashout }) {
    ...
    const getButtonText = () => {
        ...
        if (phase === 'running' && betPlaced) {
            return `Cash Out KSh ${(betAmount * multiplier).toFixed(2)}`
        }
        return 'Place Bet'
    }
                ...
                <div className="bet-form">
                    ...
                    <div className="form-group">
                        <div className="form-header">
                            ...
                            <Text type="secondary" style={{ margin: 0 }}>KSh {Number(betAmount || 0).toFixed(2)}</Text>
                        </div>
                        <div className="input-row">
                            <InputNumber
                                ...
                                step={1}
                                addonBefore={
                                    <div className="btc-icon" style={{ background: 'linear-gradient(135deg, #f7931a, #ffb347)' }}>KSh </div>
                                }
                                controls={false}
                                formatter={(v) => `${v}`}
                    ...
                    <div className="profit-card-3d mobile-sheet-secondary">
                        <div className="form-header" style={{ marginBottom: 4 }}>
                            ...
                            <Text type="secondary" style={{ margin: 0 }}>KSh {profit.toFixed(2)}</Text>
                        </div>
